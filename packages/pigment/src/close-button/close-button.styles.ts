...
export const closeButtonVariants = cva(
  [
    ...
    "pg-reset-svg pg-font-medium pg-no-underline",
  ...
  ],
  {
    variants: {
      size: {
        xs: "pg-h-7 pg-w-7 pg-rounded pg-text-base",
        sm: "pg-h-9 pg-w-9 pg-rounded-md pg-text-xl",
        md: "pg-h-11 pg-w-11 pg-rounded-md pg-text-2xl",
        lg: "pg-h-13 pg-w-13 pg-rounded-md pg-text-3xl",
        xl: "pg-h-15 pg-w-15 pg-rounded-md pg-text-4xl",
      },
      inheritTextColor: {
