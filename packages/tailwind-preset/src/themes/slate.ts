    ...
    colors: {
      content: {
        ...
        link: {
          ...
          hover: twColors.slate["900"],
          active: twColors.slate["900"],
        },
        ...
        onPrimarySubtle: twColors.slate["800"],
      ...
      surface: {
        ...
        primary: {
          ...
          subtle: {
            ...
            hover: twColors.slate["200"],
            active: twColors.slate["300"],
          },
        },
        neutral: {
  ...
  dark: {
    colors: {
      content: {
        ...
        link: {
          DEFAULT: twColors.slate["100"],
          hover: twColors.slate["50"],
          active: twColors.slate["50"],
        },
        ...
        onPrimarySubtle: twColors.slate["200"],
      ...
      surface: {
        ...
        primary: {
          ...
          subtle: {
            ...
            hover: twColors.slate["800"],
            active: twColors.slate["700"],
          },
        },
        neutral: {
