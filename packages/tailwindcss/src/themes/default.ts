...
export const defaultTheme = {
  ...
  '.dark, [data-pg-color-scheme="dark"]': {
    ...
    "--pg-color-text-subtlest": "var(--pg-color-neutral-300)",
    "--pg-color-text-dimmed": "var(--pg-color-neutral-400)",
    "--pg-color-text-inverse": "var(--pg-color-neutral-1000)",
    ...
    "--pg-color-icon-subtlest": "var(--pg-color-neutral-300)",
    "--pg-color-icon-dimmed": "var(--pg-color-neutral-400)",
    "--pg-color-icon-inverse": "var(--pg-color-neutral-1000)",
    ...
    "--pg-color-body-bg": "var(--pg-color-neutral-1000)",
    ...
    /* Surface */
    "--pg-color-surface-bg": "var(--pg-color-neutral-1000)",
