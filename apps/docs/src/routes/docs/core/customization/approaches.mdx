...
module.exports = {
  ...
  presets: [
    pigment({
      themes: ["sapphire"], // `base` is a predefined Pigment theme.
    }),
  ],
};
```
...
export default function App() {
  return (
    <div data-pg-theme="custom">
      ...
      <span data-pg-theme="sapphire">This span will use the "sapphire" theme.</span>
    </div>
  );
}
```
...
<Alert color="info" variant="soft">
  ...
  <span>the `sapphire` theme will be used by default.</span>
</Alert>
