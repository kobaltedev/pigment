...
Then add the `[data-pg-theme]` attribute to your root component and provide a theme name as value:

```tsx {1}
export default function App() {
  return <div data-pg-theme="base">...</div>;
}
```

For a SolidStart application, you will likely add it to the `Html` component in `root.tsx` file:
...
export default function Root() {
  return (
    <Html lang="en" data-pg-theme="base">
      <Head>
...
<Alert>
  ...
  <span>the `base` theme will be available by default.</span>
</Alert>
      ...
      themes: [
        {
          ...
          tokens: vars => ({
            light: {
              colors: {
                primary500: "#3b82f6",
                solidPrimaryBg: vars("colors.primary500"),
              },
            },
          }),
        },
...
[data-pg-theme="my-theme"] {
  ...
  --app-colors-solid-primary-bg: var(--app-colors-primary-500);
}
```
