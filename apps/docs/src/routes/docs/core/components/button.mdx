...
```tsx
<IconButton aria-label="Delete" icon="i-tabler-trash" />
```
...
| leadingIcon      | `JSX.Element \| (() => JSX.Element)` <br/> The icon to show before the button content.                                                            |
| trailingIcon     | `JSX.Element \| (() => JSX.Element)` <br/> The icon to show after the button content.                                                             |
| loadingIcon      | `JSX.Element \| (() => JSX.Element)` <br/> The icon to show when the button is in loading state.                                                  |
| loadingPlacement | `"center" \| "leading" \| "trailing"` <br/> **default:** `center` <br/> The placement of the loading icon when the button is in a loading state.  |
