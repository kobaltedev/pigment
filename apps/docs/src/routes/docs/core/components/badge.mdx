...
Badges supports all Pigment semantic colors: `primary`, `neutral`, `success`, `info` (default), `warning`, `danger` and `discovery`.
...
| color   | `"primary" \| "neutral" \| "success" \| "info" \| "warning" \| "danger" \| "discovery"` <br/> **default:** `"primary"` <br/> The color of the badge. |
