...
export function OpenCollectiveIcon(props: JSX.SvgSVGAttributes<SVGSVGElement>) {
  return (
...
export function BeatLoaderIcon(props: JSX.SvgSVGAttributes<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 120 30" width="1em" height="1em" {...props}>
      <g fill="currentColor">
