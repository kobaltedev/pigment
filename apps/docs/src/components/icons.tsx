...
export const TablerGitHubIcon = createIcon({
  path: () => (
    <path
      fill="none"
      stroke="currentColor"
...
export const TablerDiscordIcon = createIcon({
  path: () => (
    <g
      fill="none"
      stroke="currentColor"
    ...
    >
      ...
      <path d="M8.5 17c0 1-1.356 3-1.832 3c-1.429 0-2.698-1.667-3.333-3c-.635-1.667-.476-5.833 1.428-11.5C6.151 4.485 7.545 4.16 9 4l.975 1.923a11.913 11.913 0 0 1 4.053 0L15 4c1.5.16 3.043.485 4.5 1.5c2 5.667 2.167 9.833 1.5 11.5c-.667 1.333-2 3-3.5 3c-.5 0-2-2-2-3" />
      <path d="M7 16.5c3.5 1 6.5 1 10 0" />
    </g>
  ),
});

export const TablerTwitterIcon = createIcon({
  path: () => (
    <path
      fill="none"
      stroke="currentColor"
...
export const TablerRocketIcon = createIcon({
  path: () => (
    <g
      fill="none"
      stroke="currentColor"
...
export const TablerTagIcon = createIcon({
  path: () => (
    <g
      fill="none"
      stroke="currentColor"
...
export const TablerQuestionMarkIcon = createIcon({
  path: () => (
    <path
      fill="none"
      stroke="currentColor"
